...
The easiest way to analyse a simulation is to run the `ana.py` script generated by the `Simulate` class. All you need to do is to set the atoms and bonds you want to sample. This creates `.obj` files with the sampled data.
